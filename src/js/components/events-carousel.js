...
const eventsCarousel = (data) => {
  ...
  if (cardList.length > 1) {
    ...
    const arrowImageRight = newMultimedia('img', {
      src: 'arrow-slider.png',
      alt: 'arrow carousel',
    });
    ...
    const arrowLeft = newContainer(
      'button',
      [arrowImageLeft],
      ['carousel__button', 'carousel__button--left'],
    );
    carousel = newContainer('div', [arrowLeft, eventLink, arrowRight], ['carousel__container']);
